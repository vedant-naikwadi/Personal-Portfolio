    ...
    <section class="w3l-gallery pb-5" id="gallery" style="background-color: white;">
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mb-sm-5 mb-4">
                <h3 class="title-style" style="color: black;">Projects</h3>
            </div>
            <div class="row" style="padding-bottom: 100px;">
                ...
                <div class="col-lg-6 col-md-6 item mt-md-0 mt-4 project" style="text-align: center;">
                    <h4 style="text-align: left;">Stock Management System</h4>
                    <p>Stock Management System: Streamline inventory, reduce waste, and optimize stock levels efficiently.</p>
                    <a href="project1.py" class="btn btn-style mt-5">Know More</a>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 item mt-md-0 mt-4 project" style="text-align: center;">
                    <h4 style="text-align: left;">Online Bookstore Website</h4>
                    <p>Explore My Online Bookstore Project: A Seamless Digital Marketplace for Book Lovers, Designed to Enhance Your Reading Experience with Easy Navigation and Personalized Recommendations.</p>
                    <a href="project2.py" class="btn btn-style mt-5">Know More</a>
