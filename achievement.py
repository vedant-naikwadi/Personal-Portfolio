...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarScroll">
                    <ul class="navbar-nav mx-auto my-2 my-lg-0 navbar-nav-scroll">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="achievement.py">Achievements</a>
                        </li>
                        <li class="nav-item">
    ...
    <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title pt-sm-5 pt-4">Achievements</h4>
                <ul class="breadcrumbs-custom-path mt-2">
                    <li><a href="index.py">Home</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Achievements</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <div class="photo-gallery">
        <div class="container">
            <div class="intro">
                <h2 class="text-center" style="color: black;">Achievements</h2>
                <p class="text-center">Milestones & Achievements: Highlights of My Journey</p>
            </div>
            <div class="row photos">
                
                <div class="col-sm-6 col-md-4 col-lg-3 item">
                    <a href="assets/images/v/c1 (1).jpeg" data-lightbox="photos">
                        <img class="img-fluid" src="assets/images/v/c1 (1).jpeg">
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item">
                    <a href="assets/images/v/c1 (2).jpeg" data-lightbox="photos">
                        <img class="img-fluid" src="assets/images/v/c1 (2).jpeg">
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item">
                    <a href="assets/images/v/c1 (3).jpeg" data-lightbox="photos">
                        <img class="img-fluid" src="assets/images/v/c1 (3).jpeg">
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item">
                    <a href="assets/images/v/c1 (4).jpeg" data-lightbox="photos">
                        <img class="img-fluid" src="assets/images/v/c1 (4).jpeg">
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item">
                    <a href="assets/images/v/c1 (5).jpeg" data-lightbox="photos">
                        <img class="img-fluid" src="assets/images/v/c1 (5).jpeg">
                    </a>
                </div>
                <div class="col-sm-6 col-md-4 col-lg-3 item">
                    <a href="assets/images/v/c1 (6).jpeg" data-lightbox="photos">
                        <img class="img-fluid" src="assets/images/v/c1 (6).jpeg">
                    </a>
                </div>
            </div>
        </div>
