    ...
    <section class="inner-banner py-5">
        <div class="w3l-breadcrumb py-lg-5">
            <div class="container pt-4 pb-sm-4">
                <h4 class="inner-text-title font-weight-bold pt-sm-5 pt-4">Stock Management System</h4>
                <ul class="breadcrumbs-custom-path">
                    <li><a href="project.py">Projects</a></li>
                    <li class="active"><i class="fas fa-angle-right mx-2"></i>Project-1</li>
                </ul>
            </div>
        </div>
    </section>
    ...
    <section class="w3l-gallery pb-5" id="gallery" style="background-color: white;">
        <div class="container py-md-5 py-4">
            <div class="title-heading-w3 text-center mb-sm-5 mb-4">
                <h3 class="title-style" style="color: black;">Stock Management System</h3>
            </div>
                    ...
                    <div class="container">
                        ...
                        <div class="row photos">
                            <div class="col-sm-6 col-md-4 col-lg-3 item">
                                <a href="assets/images/v/s1.jpg" data-lightbox="photos">
                                    <img class="img-fluid" src="assets/images/v/s1.jpg">
                                </a>
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3 item">
                                <a href="assets/images/v/s2.jpg" data-lightbox="photos">
                                    <img class="img-fluid" src="assets/images/v/s2.jpg">
                                </a>
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3 item">
                                <a href="assets/images/v/s3.jpg" data-lightbox="photos">
                                    <img class="img-fluid" src="assets/images/v/s3.jpg">
                                </a>
                            </div>
                            <div class="col-sm-6 col-md-4 col-lg-3 item">
                                <a href="assets/images/v/s4.jpg" data-lightbox="photos">
                                    <img class="img-fluid" src="assets/images/v/s4.jpg">
                                </a>
                            </div>
